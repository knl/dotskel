...
hotkey.bind(hyper, 'm', function() application.launchOrFocus("Thunderbird") end)
hotkey.bind(hyper, 'o', function() application.launchOrFocus("Trello") end)
hotkey.bind(hyper, 't', function() application.launchOrFocus(os.getenv('HOME') .. '/Applications/Home Manager Apps/Ghostty.app') end)
