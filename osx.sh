...
# Enable press-and-hold for keys (oposite: key repeat)
...
defaults write NSGlobalDomain AppleLanguages -array "en, de, sr"
...
# Bottom right screen corner → Missing control
...
# Display the annoying prompt when quitting iTerm
...
# Copy selection automatically in iTerm
defaults write com.googlecode.iterm2 CopySelection -bool true
# Use a smart placement of windows
