# Originally generated by Powerlevel10k configuration wizard on 2021-03-06.
# Ported on 2026-06-11 onto config/p10k-lean.zsh from powerlevel10k a0c9dbe8,
# carrying over all local customizations (jj_vcs and my_note segments, segment
# layout, compatible-mode icons, git formatter, etc.).
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # These four are the last ones as they show up most of the time
  ...
  function my_git_formatter() {
    ...
    # If local branch name or tag is at most 48 characters long, show it in full.
    # Otherwise show the first 12 … the last 12.
    (( $#where > 48 )) && where[21,-21]="…"
    ...
    typeset -g my_git_format="%f·· ($res%f)"
  }
  ...
  # Kept unset so that Git status is shown in $HOME too.
  ...
  # Context is always shown. Uncomment the next line to hide it unless running with
  # privileges or in SSH.
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Kubecontext is always shown. Uncomment the next line to show it only when the command
  # you are typing invokes one of these tools.
  ...
  # Show or hide the my_note prompt line (line 2) depending on the presence of ./.note.
